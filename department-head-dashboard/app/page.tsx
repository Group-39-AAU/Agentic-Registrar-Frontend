      ...
      <main className="mx-auto flex w-full max-w-[460px] flex-1 items-center px-5 py-8">
        <div className="aau-card w-full rounded-2xl p-7">
          <div className="mb-5 text-center">
            ...
            <h1 className="mt-3 text-[24px] font-bold tracking-[-0.01em] text-[#2a66a7]">Department Head Login</h1>
            <p className="text-[13px] text-[#5a5a5a]">
              Sign in to review and authorise submitted grades.
            </p>
          </div>
